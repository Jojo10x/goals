...
const AddGoalForm: React.FC<AddGoalFormProps> = ({ onAddGoal, showSnackbar }) => {
  ...
  return (
    <div className="space-y-4">
      <button
        className="px-4 py-2 text-sm font-medium text-white bg-indigo-600 rounded-lg hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 flex items-center justify-center"
      ...
      {showModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
          <div className="bg-white w-full max-w-md p-6 rounded-lg shadow-lg relative">
            ...
            <h2 className="text-lg font-medium text-gray-800 mb-4">Add a New Goal</h2>
            <input
              type="text"
              value={newGoal}
